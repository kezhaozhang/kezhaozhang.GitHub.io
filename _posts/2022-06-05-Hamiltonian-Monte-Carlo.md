...
<figure>
  ...
  <center>
  <figurecaption>
  Figure 2. The acceptance rate of the Metropolis algorithm as a function of δ.
  </figurecaption>
  </center>
</figure>
...
<figure>
  ...
  <center>
  <figurecaption>
  Figure 3. Autocorrelation of the traces generated by the Metropolis algorithm for various values of δ. Autocorrelation is positive.
  </figurecaption>
  </center>
</figure>
...
<figure>
  ...
  <center>
  <figurecaption>
  Figure 4. Autocorrelation of the traces generated by the Hamiltonian Monte Carlo algorithm for various step sizes (ε) and numbers of steps (<i>L</i>) in the leapfrog integration. Autocorrelation is negative on odd lags in some cases.
  </figurecaption>
  </center>
</figure>
...
<figure>
  ...
  <center>
  <figurecaption>
  Figure 5. The area under the autocorrelation curve of the traces generated by the Metropolis algorithm for various δ. The minimum AUC=1.9 at δ=5.
  </figurecaption>
  </center>
</figure>
...
<figure>
  ...
  <center>
  <figurecaption>
  Figure 6. The area under the autocorrelation curve of the traces generated by the Hamiltonian Monte Carlo algorithm for various ε<i>L</i>. The minimum AUC=0.72 at ε<i>L</i>=2. Here ESS is relative, which is the ratio of effective sample size and the sample size.
  </figurecaption>
  </center>
</figure>
...
<figure>
  ...
  <center>
  <figurecaption>
  Figure 9. Traces generated by the Metropolis algorithm. Top: δ=0.5; Bottom: δ=5. The former is not as good as the latter: more discrepancy between the sample  and the target distributions; and stronger autocorrelation. 
  </figurecaption>
  </center>
</figure>
...
<figure>
  ...
  <center>
  <figurecaption>
  Figure 10.  Traces generated by the Hamiltonian Monte Carlo. Top: ε=0.2 and <i>L</i>=20; Bottom: ε=0.1 and <i>L</i>=20. The former is not as good as the latter: more discrepancy between the sample and the target distributions; and larger nonuniformity. 
  </figurecaption>
  </center>
</figure>
